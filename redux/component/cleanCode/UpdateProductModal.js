...
import { Modal, View, TextInput, Button, Text, TouchableOpacity } from 'react-native';
    ...
    >
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>
        <View style={{ backgroundColor: '#fff', padding: 20, borderRadius: 10, width: '80%', marginTop: 50 }}>
          <Text style={{ fontSize: 20, fontWeight: 'bold', marginBottom: 20, textAlign: 'center' }}>Cập nhật sản phẩm</Text>
          <TextInput
          ...
          <TextInput
            ...
            value={giaSP.toString()}
            onChangeText={text => setGiaSP(Number(text))}
          ...
          <TextInput
            ...
            value={giamGia.toString()}
            onChangeText={text => setGiamGia(Number(text))}
            keyboardType="numeric"
          />
          ...
          <TextInput
            ...
            value={soLuongDanhGia.toString()}
            onChangeText={text => setSoLuongDanhGia(Number(text))}
            keyboardType="numeric"
          />
